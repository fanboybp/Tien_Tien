...
df = pd.read_csv('C:\\Users\\gatva\\Documents\\Zalo Received Files\\hondao.csv')
...
# Tính toán số trung tâm có số lượng đơn > 200 và loại thực phẩm tiêu thụ nhiều nhất
...
# Ghi kết quả vào file fileoutput.txt
